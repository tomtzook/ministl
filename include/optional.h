...
template<typename t_>
constexpr t_&& optional<t_>::operator*() && { return framework::move(_get()); }
...
template<typename t_>
constexpr t_& optional<t_>::value() & { return _get(); }

template<typename t_>
constexpr const t_& optional<t_>::value() const & { return _get(); }

template<typename t_>
constexpr t_&& optional<t_>::value() && { return framework::move(_get()); }

template<typename t_>
constexpr const t_&& optional<t_>::value() const && { return framework::move(_get()); }
